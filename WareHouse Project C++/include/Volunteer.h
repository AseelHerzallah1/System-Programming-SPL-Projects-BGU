...
enum class volunteerType{
    CollectorVolunteer ,DriverVolunteer, LimitedCollectorVolunteer, LimitedDriverVolunteer, NoType
};
...
class Volunteer {
    public:
        ...
        void setType(volunteerType volType);
        volunteerType getType() const;
